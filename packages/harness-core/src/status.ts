export type HarnessAdapterRuntimeState =
  | "configured_lazy"
  | "opening"
  | "opened"
  | "failed"
...
export interface HarnessAdapterStatusSnapshot<THarnessId extends string = string> {
  readonly id: THarnessId;
  readonly state: HarnessAdapterRuntimeState;
  readonly reason?: string;
}

export interface HarnessRuntimeStatusSnapshot<THarnessId extends string = string> {
  readonly adapters: readonly HarnessAdapterStatusSnapshot<THarnessId>[];
}
